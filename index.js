...
if(secondAnswer === 'follow') {
    ...
    if(secondAnswer==='stay'){
        let secondAnswer = window.prompt('you stay with cat')
    }

    if (secondAnswer==='spread the word'){
        let secondAnswer= window.prompt('you tell people but no believe')
    }
    }
...
if(secondAnswer==='draw it'){
    let secondAnswer = window.alert('You draw the flower, capturing only a fraction of its beauty with your quill. You bring the drawing home, somewhat disappointed, but over time, discover joy in sharing it with your friends and family, recounting the story of your days as a sorcerer with the aid of the sketch.')
}
...
if(secondAnswer==='run'){
    let secondAnswer=window.alert("Quickly, you run back to the cave'  entrance. Sheepish, you return home")
